...
## 
## Makefile     : delay.mk
## Generated on : Sat Feb 01 17:04:40 2020
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\delay.exe
...
COMPILER_COMMAND_FILE     = delay_comp.rsp
CMD_FILE                  = delay.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\delay.exe
...
DEFINES_STANDARD = -DMODEL=delay -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\delay_grt_rtw\delay.cpp $(START_DIR)\delay_grt_rtw\rtGetInf.cpp $(START_DIR)\delay_grt_rtw\rtGetNaN.cpp $(START_DIR)\delay_grt_rtw\rt_nonfinite.cpp
...
OBJS = rt_logging.obj delay.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
{$(START_DIR)\delay_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\delay_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
