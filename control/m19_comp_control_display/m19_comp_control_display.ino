/* m19_comp_control_display.ino
 * 
 * runs the ECVT using California 2019 competition code with the addition of an I2C display
 * 
...
const int refreshPeriod = 1e6; // display refresh time [us]
...
//    Serial.print("\n");
  ...
  // refresh display
  if (current_micros - last_refresh_time >= refreshPeriod) {
    update_display();
    last_refresh_time = current_micros;
  }
}
